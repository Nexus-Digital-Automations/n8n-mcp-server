...
export default {
  ...
  transformIgnorePatterns: ['node_modules/(?!(node-fetch|fastmcp|@modelcontextprotocol|zod)/)'],
  ...
  // Setup files
  setupFilesAfterEnv: ['<rootDir>/tests/setup.ts', '<rootDir>/src/__tests__/setup.ts'],
  ...
  watchPathIgnorePatterns: ['/node_modules/', '/build/', '/coverage/', '/.git/'],
};
